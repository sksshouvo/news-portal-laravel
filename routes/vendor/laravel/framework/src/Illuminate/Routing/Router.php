...
class Router implements RegistrarContract, BindingRegistrar
{
    ...
    public function auth(array $options = [])
    {
        ...
        $this->get('/news_admin/login', 'Auth\LoginController@showLoginForm')->name('login');
        $this->post('/news_admin/login', 'Auth\LoginController@login');
        $this->post('logout', 'Auth\LoginController@logout')->name('logout');

        // Registration Routes...
        if ($options['register'] ?? true) {
            $this->get('/news_admin/register', 'Auth\RegisterController@showRegistrationForm')->name('register');
            $this->post('/news_admin/register', 'Auth\RegisterController@register');
        }
