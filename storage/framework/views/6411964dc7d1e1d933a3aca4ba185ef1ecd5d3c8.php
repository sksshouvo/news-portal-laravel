           ...
           <br>
            <table class="table table-responsive table-bordered">
                ...
                <tr>
                    ...
                    <td>
                    <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#edit_modal<?php echo e($udata->id); ?>" onclick="edit_udata(<?php echo e($udata->id); ?>)"><em class="fa fa-edit"></em></button>
                    </td>
                </tr>
                <!!--edit user modal--!!>
                <div class="modal fade" id="edit_modal<?php echo e($udata->id); ?>" tabindex="-1" role="dialog">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="users/<?php echo e($udata->id); ?>" method="POST" id="user_update">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                <input type="hidden" id="updated_by" name="updated_by" value="<?php echo e(Auth::id()); ?>">
                                <input type="hidden" id="user_id" name="user_id" value="<?php echo e($udata->id); ?>" >

                              <label for="name">Name: </label>
                              <input type="text" id="name" name="name" class="form-control" value="<?php echo e($udata->name); ?>">
                             
                              <label for="email">Email: </label>
                              <input type="text" name="email" id="email" class="form-control" value="<?php echo e($udata->email); ?>">
                              
                              <label for="password">Password: </label>
                              <input type="text" id="password" name="password" class="form-control">
                             
                              <label for="mobile">Mobile: </label>
                              <input type="text" id="mobile" name="mobile" value="<?php echo e($udata->mobile); ?>" class="form-control">
                             
                              <label for="country">Country: </label>
                              <select name="country_id" id="country_<?php echo e($udata->id); ?>" class="form-control">


                              </select>
                             
                              <label for="designation">Designation: </label>
                            <select name="desg_id" id="designation_<?php echo e($udata->id); ?>" class="form-control">


                            </select>
                            
                             <label for="concern">Concern: </label> 
                             <select name="concern_id" id="concern_id_<?php echo e($udata->id); ?>" class="form-control">
