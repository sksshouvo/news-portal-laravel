<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
   ...
   {{-- <form role="search">
    ...
    <ul class="nav menu">
        ...
        @if (strpos(Request::url(),"update_news"))
        <li class="parent"><a data-toggle="collapse" href="#sub-item" >
          ...
          <li {{{ (Request::is('users') ? 'class=active' : '') }}} ><a href="../users"><em class="fa fa-user">&nbsp;</em> Users</a></li>    
          <li {{{ (Request::is('designation') ? 'class=active' : '') }}} ><a href="../designation"><em class="fa fa-briefcase">&nbsp;</em> Designation</a></li>
          <li {{{ (Request::is('concern') ? 'class=active' : '') }}} ><a href="../concern"><em class="fa fa-cog">&nbsp;</em> Concern</a></li>
          <li {{{ (Request::is('main_settings') ? 'class=active' : '') }}} ><a href="../main_settings"><em class="fa fa-cogs">&nbsp;</em> Main Settings</a></li>
          <li {{{ (Request::is('social_medias') ? 'class=active' : '') }}} ><a href="../social_medias"><em class="fa fa-user">&nbsp;</em>Social Media</a></li>
          <li {{{ (Request::is('categories') ? 'class=active' : '') }}} ><a href="../categories"><em class="fa fa-list">&nbsp;</em>Category</a></li>
          <li {{{ (Request::is('ads') ? 'class=active' : '') }}} ><a href="../ads"><em class="fa fa-film">&nbsp;</em>Ads</a></li>
          <li class="parent"><a data-toggle="collapse" href="#sub-item-2" >
            ...
            <ul class="children collapse" id="sub-item-2">
                <li {{{ (Request::is('set_as_breaking_news') ? 'class=active' : '') }}} ><a href="../set_as_breaking_news"><em class="fa fa-arrow-right">&nbsp;</em>For Breaking News</a></li> 
                <li {{{ (Request::is('set_as') ? 'class=active' : '') }}} ><a href="../set_as"><em class="fa fa-arrow-right">&nbsp;</em>For home page</a></li> 
        ...
        @else
        <li {{{ (Request::is('dashboard') ? 'class=active' : '') }}} ><a href="dashboard"><em class="fa fa-dashboard">&nbsp;</em> Dashboard</a></li>
        <li class="parent"><a data-toggle="collapse" href="#sub-item" >
          <em class="fa fa-navicon">&nbsp;</em>News<span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
          </a>
          <ul class="children collapse" id="sub-item">
