				...
				<ul class="nav navbar-top-links navbar-right">
					<li class="dropdown"><a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
						...
						<ul class="dropdown-menu dropdown-messages">
							<li>
							<p style="padding-left: 4%;padding-top: 3%;"><a href="{{$_SERVER['PHP_SELF']}}" target="_black">Go to your site</a></p>
							</li>
							<li>
							<p style="padding-left: 4%;padding-top: 3%;"> <a href="javascript:void(0)" data-toggle="modal" data-target="#myProfile" onclick="country('{{Auth::user()->country_id}}')"> Your profile</a></p>
							</li>
							<li class="divider"></li>
							<li>
    ...
    <div class="modal-content">
	  ...
	  <form method="POST" action="./users/{{Auth::id()}}">
		...
		<div class="modal-body">
			...
			<input type="tel" name="mobile" id="mobile" value="{{Auth::user()->mobile}}" class="form-control">
			<label for="country">Country: </label>
			<select name="country_{{Auth::id()}}" id="country_{{Auth::id()}}" class="form-control"></select>
		  </div>
	  </form>
