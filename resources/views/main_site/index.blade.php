  ...
  <div class="container">
    <div class="row align-items-center">
        ...
        <div class="breaking-news-area d-flex align-items-center">
          ...
          <div id="breakingNewsTicker" class="ticker">
            <ul>
              ...
              @endphp
              @foreach ($bn as $nbn)
              <li><a   href="./news_details/{{$nbn->post_url_bng}}">{{$nbn->post_title_bng}}</a></li>
              @endforeach
            </ul>
          </div>
        </div>
      ...
      {{-- <div class="col-12 col-lg-4">
        <div class="hero-add"> @php
          $ads1 = Storage::url('app/public/img/bg-img/hero-add.gif')
          @endphp <a   href="#"><img src="{{$ads1}}" alt="ad1"></a> </div>
      </div> --}}
    </div>
  </div>
</div>
        ...
        <div class="row"> 
          ...
          <div class="col-12 col-lg-6">
            <div class="single-blog-post featured-post">
              <div class="post-thumb"> <a   href="./news_details/{{$f_news->post_url_bng}}"><img src="{{$img1}}" alt=""></a> </div>
              <div class="post-data"><a   href="./news_details/{{$f_news->post_url_bng}}    " class="post-title">
                <h6>{{$f_news->post_title_bng}}</h6>
                </a> </div>
            </div>
          </div>
          <!-- Single Post -->
          <div class="col-12 col-lg-3">
            <div class="single-blog-post">
              <div class="post-thumb"> <a   href="#"><img src="{{$img2}}" alt=""></a> </div>
              <div class="post-data"> <a   href="./news_details/{{$c_news1->post_url_bng}}" class="post-title">
                <h6>{{$c_news1->post_title_bng}}</h6>
                </a>
                <div class="post-meta"> 
                  <p class="post-excerp">{{$truncated}}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-lg-3">
            <div class="single-blog-post">
              <div class="post-thumb"> <a   href="./news_details/{{$c_news2->post_url_bng}}"><img src="{{$img3}}" alt=""></a> </div>
              <div class="post-data"> <a   href="./news_details/{{$c_news2->post_url_bng}}" class="post-title">
                <h6>{{$c_news2->post_title_bng}}</h6>
                </a>
                <div class="post-meta">
                  <p class="post-excerp">{{$truncated2}}</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="row">
      <div class="col-12">
        <div class="footer-add"> @php
          ...
          @endphp <a   href="#"><img src="{{$ads2}}" alt="ad2"></a> </div>
      </div>
    </div>
  </div>
</div>-->
    ...
    {{-- <div class="col-12 col-md-5 col-lg-3">
      <div class="single-blog-post style-2">
        <div class="post-thumb"> @php
          ...
          @endphp <a   href="#"><img src="{{$ads111}}" alt="ad111"></a> </div>
      </div>
      <br>
      <br>
      <div class="single-blog-post style-2">
        <div class="post-thumb"> @php
          ...
          @endphp <a   href="#"><img src="{{$ads11}}" alt="ad11"></a> </div>
      </div>
    </div> --}}
  </div>
</div>
...
<script src='{{asset('js/main_site/custom_js.js')}}'></script> 
@endsection