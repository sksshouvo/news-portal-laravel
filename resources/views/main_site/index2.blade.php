@include('main_site.includes.site_header')
@include('main_site.includes.site_navbar')
    <!-- ##### Header Area End ##### -->
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="breaking-news-area d-flex align-items-center">
                        ...
                        <div id="breakingNewsTicker" class="ticker">
                            <ul>
                                @php
                                $bn = App\news_table::where('post_status', '=', 1)->orderBy('id', 'desc')->take(5)->get();
                                
                                @endphp
                                @foreach ($bn as $nbn)
                                <li><a href="./news/{{$nbn->post_url_bng}}">{{$nbn->post_title_bng}}</a></li>
                                @endforeach
                ...
                <div class="col-12 col-md-6 col-lg-8">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-7">
                            @php
                            $f_news = App\news_table::where('set_as', "f_news")->select('post_title_bng', 'id')->first();
                            $f_image = App\f_image::where('post_id', $f_news->id)->select('image_path', 'image_name')->first();
                            $url3 = Storage::url($f_image['image_path'].$f_image['image_name']);
                            @endphp
                            <div class="single-blog-post featured-post">
                                    <div class="post-thumb">
                                        <a href="#"><img src="{{$url3}}" alt="image_f"></a>
                                    </div>
                                    <div class="post-data">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    @include('main_site.includes.site_footer')
